  ...
  return (
    <div className="max-w-2xl">
      <div className="mb-8">
        ...
        {unread.length > 0 && <p className="text-sm text-red-400 mt-1">{unread.length} need your attention</p>}
      </div>
      ...
      {unread.length === 0 && read.length === 0 && (
        <div className="bg-zinc-900 rounded-xl border border-zinc-800 p-16 text-center">
          ...
          <p className="text-zinc-600 text-xs mt-1">Notifications appear here when homeowners need manual scheduling.</p>
        </div>
      )}
      ...
      {unread.length > 0 && (
        <div className="mb-8">
          ...
          <div className="flex flex-col gap-3">
            {unread.map((n: any) => (
              <div key={n.id} className="bg-zinc-900 rounded-xl border border-red-500/30 p-5">
