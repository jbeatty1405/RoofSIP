      ...
      <section className="py-24 px-5 border-t border-zinc-800/60">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="mt-8 flex flex-col items-center gap-2.5">
            <p className="text-zinc-500 text-sm">Already a member? Get the iOS app</p>
            <a
              href="https://apps.apple.com/us/app/id6772607538"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2.5 bg-black hover:bg-zinc-900 border border-zinc-700 hover:border-zinc-500 text-white px-5 py-2.5 rounded-xl transition-colors"
            >
